...
**Standard.** Automations or scripts that automatically shut down rooms, power off media
...
**Standard.** Automations and scripts that can produce **real-world alerts or security
...
**Standard.** A Home Assistant **domain reload** (`template.reload`, `script.reload`,
...
**Standard.** **Scope:** This standard applies to **every repository** that installs this

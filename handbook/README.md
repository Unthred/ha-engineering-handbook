...
The chapters progress from durable principles to concrete engineering practice.

1. [Philosophy](00-philosophy.md)
2. [Architecture](01-architecture.md)
3. [Naming and YAML](02-naming-and-yaml.md)
4. [Automations](03-automations.md)
5. [Dashboards and UX](04-dashboards-and-ux.md)
6. [Security and secrets](05-security-and-secrets.md)
